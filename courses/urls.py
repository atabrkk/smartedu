...
urlpatterns = [
    ...
    path('categories/<slug:category_slug>', views.category_list, name="courses_by_category"),  # Category göre Course listeler. http://127.0.0.1:8000/courses/categories/web-programming
